        ...
        <div class="md:flex md:justify-center md:gap-10 md:ítems-center">
            ...
            <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
                ...
                <form action="/crear-cuenta" method="POST">
                    ...
                    <div class="mb-5">
                        <label for="number" class="mb-2 block uppercase text-gray-500 font-bold">Cedula</label>
                        <input type="text" name="card" id="card" placeholder="Cedula" class="border p-3 w-full rounded-lg @error ('card')
                        border-red-500
                        @enderror">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="phone" id="phone" placeholder="Telefono" class="border p-3 w-full rounded-lg @error ('phone')
                        border-red-500
                        @enderror">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="address" id="address" placeholder="Dirección" class="border p-3 w-full rounded-lg @error ('address')
                        border-red-500
                        @enderror">
